                ...
                <div className="container-fluid px-3 d-flex align-items-center">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li className = "nav-item mb-2 mb-lg-0">
                                <NavLink to="/explore"  className="common" activeClassName="active">Explore</NavLink>
                            </li>
                            {
                                user.email ? 
                                    <>
                                        <li className="nav-item mb-2 mb-lg-0">
                                            <NavLink to="/dashboard" className="common" activeClassName="active">Dashboard</    NavLink>
                                        </li>
                                        <li className = "nav-item mb-2 mb-lg-0">
